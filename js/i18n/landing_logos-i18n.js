jQuery(document).ready(function() {
  ...
  $.i18n().load({
    ...
    'es': {
      ...
      /* HERO */
      'hero-title': 'Diseño de Logotipos para tu empresa, marca o negocio al mejor precio.',
      ...
      'hero-desc5': 'Un gran logo incorpora todos los elementos de tu negocio en una sola imagen. Evoca a la personalidad y actitud de una manera comprensible. El Logotipo debe de ser unico y memorable, profesional pero con caracter. Tu logo debe de ser escalable a distintos tamaños de manera que sea visible en culaquier pantalla, papelería o mercancía. Nosotros podemos hacerlo por ti.',
      /* FORM */
      ...
      /* SERVICES SECTION */
      'intro-packs': 'Diseño de logotipos',
      'intro-packs-welcome': 'En Animeishon Studio diseñamos logotipos para tu empresa al mejor precio sin sacrificar calidad. Tu logo debe incluir todos los elementos necesarios para lograr comunicar el mensaje con solo un vistazo. Selecciona el paquete que más te convenga:',
      'intro-modal-quote': 'Cotiza',
      'intro-modal-bundle1': 'Rediseño',
      'intro-modal-bundle1-bullet1': 'Diseño Personalizado',
      ...
      'intro-modal-bundle1-bullet6': 'Ideal para Rediseño',
      'intro-modal-bundle1-bullet7': 'Entregas en 48 horas',
      'intro-modal-bundle1-bullet8': '1,000 MXN',       
      'intro-modal-bundle2': 'Rápido',
      'intro-modal-bundle2-bullet1': 'Diseño Personalizado',
      ...
      'intro-modal-bundle4-bullet1': 'Diseño Personalizado',
